...
public class KinesisSupervisorTest extends EasyMockSupport
{
  ...
  public void testNoInitialState() throws Exception
  {
    ...
    expectLastCall().anyTimes();
    EasyMock.expect(supervisorRecordSupplier.getEarliestSequenceNumber(anyObject())).andReturn("0").anyTimes();
  ...
  public void testDatasourceMetadata() throws Exception
  {
    ...
    EasyMock.expect(supervisorRecordSupplier.getLatestSequenceNumber(anyObject())).andReturn("100").anyTimes();
    supervisorRecordSupplier.seek(anyObject(), anyString());
    expectLastCall().anyTimes();
  ...
  {
    EasyMock.expect(supervisorRecordSupplier.getPartitionIds(anyObject())).andReturn(Collections.emptySet()).anyTimes();
